...
2. When the effect size is larger than 4, the sample average of μ̂ when the null is rejected is approximately equal to the true value of μ. That’s because as the power is increasing.
